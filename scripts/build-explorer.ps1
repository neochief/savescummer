param([string]$BuildDirectory = "$PSScriptRoot/../build/explorer", [string]$Generator = 'Visual Studio 16 2019')
...
& $cmake -S (Join-Path $root 'integrations/windows-explorer') -B $BuildDirectory -G $Generator -A x64
